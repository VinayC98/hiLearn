...
public class eng_sec_two extends AppCompatActivity {
    Button list_sci_one,list_sci_two,list_sci_three,next,prev;;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_eng_sec_two );
    ...
    public void stem1()
    {
        Intent intent = new Intent(this,eng_sec2_ch1.class);
        startActivity(intent);
    }
    public void stem2()
    {
        Intent intent = new Intent(this,eng_sec2_ch2.class);
        startActivity(intent);
    }
    public void stem3()
    {
        Intent intent = new Intent(this,eng_sec2_ch3.class);
        startActivity(intent);
    }
    public void stem4()
    {
