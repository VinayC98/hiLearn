...
public class chapter_list_science extends AppCompatActivity {
    Button list_sci_one,list_sci_two,list_sci_three,list_sci_four,list_sci_next,list_sci_prev;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_chapter_list_science );
    ...
    public void stem1()
    {
        Intent intent = new Intent(this,bio_unit_one_chap1.class);
        startActivity(intent);
    }
    public void stem2()
    {
        Intent intent = new Intent(this,bio_unit_one_chap2.class);
        startActivity(intent);
    }
    public void stem3()
    {
        Intent intent = new Intent(this,bio_unit_one_chap3.class);
        startActivity(intent);
    }
    public void stem4()
    {
