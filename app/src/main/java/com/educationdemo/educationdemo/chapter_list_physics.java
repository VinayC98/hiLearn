...
public class chapter_list_physics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_chapter_list_physics );
    ...
    public void stem1()
    {
        Intent intent = new Intent(this,phy_part_one_chap1.class);
        startActivity(intent);
    }
    public void stem2()
    {
        Intent intent = new Intent(this,phy_part_one_chap2.class);
        startActivity(intent);
    }
    public void stem3()
    {
        Intent intent = new Intent(this,phy_part_one_chap3.class);
        startActivity(intent);
    }
    public void stem4()
    {
        Intent intent = new Intent(this,phy_part_one_chap4.class);
        startActivity(intent);
    }
    public void stem5()
    {
        Intent intent = new Intent(this,phy_part_one_chap5.class);
        startActivity(intent);
    }
